const createTaskHtml = (name,description,assignedTo,dueDate,status,id) => { 
    ...
    const color = status == "TODO" ? "btn btn-outline-warning" : "btn-primary";
    const html = `<li class="list-group-item">
                  <div class="task" data-task-id=${id}>
                    <div class="task-top">
                      ...
                      <div>
                          <span class="btn btn-info ${color} task-status">${status}</span>
                      </div>
                    </div>
                    <div class="task-desc">
                    ...
                    <div>
                      <span class="task-date"><strong> Due date: </strong> ${dueDate}</span>
                    </div>
